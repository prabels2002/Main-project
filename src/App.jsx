    ...
    return (
        <Container style={{ padding:"100px", backgroundColor: "", paddingLeft : "" }}>
            ...
            <Row style={{ marginLeft:"0.5px" }}>
                ...
                <Col style={{ "paddingRight":"1px", "borderRight":"0px solid #000000",  "paddingLeft" : "1px", }}>
                    <div style={{ "backgroundColor": "#343a3f", "height":"100%", overflowY:"auto", }}>
                          <Row style={{ marginRight:"0px" }}  >
                              <Card style={{ width:'100%', alignSelf:'center', marginLeft:"5px","backgroundColor": "#36454f", color: "white", }}>
                                <Card.Header>
                                    Chats
                                </Card.Header>
                              </Card>
                ...
                <Col xs={ 8 } style={{ "paddingLeft":"0px",  }}>
                    <div style={{ "backgroundColor":"", "height":"100%" ,"border":"0px solid #000000"}}>
                        {/* Chat header with refresh button, username and public key are rendered here */}
                        <Row style={{ marginRight:"0px" }}>
                              <Card style={{ width:'100%', alignSelf:'center', margin:"0 0 5px 15px", backgroundColor : "#36454f", color: "white" }}>
                                <Card.Header>
                        ...
                        <div className="MessageBox" style={{ height:"500px", overflowY:"auto",  }}>
                           { Messages }
                        </div>
                        {/* The form with send button and message input fields */}
                        <div className="SendMessage"  style={{ position:"relative", bottom:"0px", padding:"10px 45px 0 45px", margin:"0 98px 0 0", width:"100%" }}>
                            <Form onSubmit={ (e) => {
			                	e.preventDefault();
